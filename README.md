...
Il workflow `.github/workflows/build-windows.yml` crea una build Windows Release e pubblica l'archivio `Preventivi-Windows.zip` negli artifact di GitHub Actions.
