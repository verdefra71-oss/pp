...
class PdfGenerator {
  static Future<void> generaECondividiPreventivo({
    ...
    // Usa un font Unicode incorporato nel PDF: il font predefinito può non
    // contenere il carattere € e quindi mostrarlo come carattere mancante.
    final pdfFont = await PdfGoogleFonts.openSansRegular();
    final pdfFontBold = await PdfGoogleFonts.openSansBold();
